...
export class CreateProductDto {
  ...
  @ApiProperty({ example: 120.0, description: 'Base premium amount per month' })
  @IsNumber()
  @Min(0)
  basePremium: number;

  @ApiPropertyOptional({
    example: 'company-uuid-123456',
    description:
      'ID of company the product belongs to (Platform Admin only can set)',
  })
  @IsOptional()
  @IsUUID()
  companyId?: string;
