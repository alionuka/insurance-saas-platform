...
export class MlModelsController {
  @Get()
  @ApiOperation({ summary: 'Get ML model training metrics and plot configurations (platform admin only)' })
  @ApiResponse({ status: 200, description: 'ML models metadata retrieved successfully' })
