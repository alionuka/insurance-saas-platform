...
function SignInPageContent() {
  ...
  return (
    <div className="bg-white py-8 px-4 shadow-xl border border-slate-200 sm:rounded-2xl sm:px-10">
      ...
      {/* Demo-mode quick-login. Gated behind NEXT_PUBLIC_DEMO_MODE so the
          buttons + plaintext seeded passwords never reach production. Local
          dev (.env.local sets this to true) and Playwright e2e see them;
          public prod (Vercel without the var) does not. */}
