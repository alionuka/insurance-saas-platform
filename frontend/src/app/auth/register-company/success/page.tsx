  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-[#060b1a] flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative">
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-lg">
        ...
        <h1 className="mt-6 text-center text-3xl font-bold tracking-tight text-slate-900 dark:text-slate-100">
          {t('auth.pendingReviewTitle')}
        </h1>
        <p className="mt-3 text-center text-slate-600 dark:text-slate-400 leading-relaxed">
          {t('auth.pendingReviewSubtitle1')}{' '}
          <span className="text-slate-900 dark:text-slate-100 font-semibold inline-flex items-center gap-1">
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-lg">
        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-6 shadow-xl space-y-5">
          ...
          <div className="flex items-start gap-3 opacity-60">
            <div className="h-5 w-5 rounded-full border-2 border-slate-300 dark:border-slate-700 shrink-0 mt-0.5" />
            <div>
              <p className="text-sm font-medium text-slate-900 dark:text-slate-100">
...
export default function RegisterCompanySuccessPage() {
  return (
    <Suspense
      fallback={
        <div className="min-h-screen bg-slate-50 dark:bg-[#060b1a] flex items-center justify-center">
