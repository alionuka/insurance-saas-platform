    ...
    <div className="min-h-screen bg-zinc-950 flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative">
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <p className="mt-2 text-center text-sm text-zinc-400">
          ...
          <Link href="/auth/sign-in" className="font-medium text-teal-400 hover:text-teal-300">
              ...
              <div>
                ...
                <div className="mt-1 relative">
                  <input
                    ...
                    className="appearance-none block w-full px-3 py-2 border border-zinc-800 rounded-lg bg-zinc-950 text-white placeholder-zinc-500 focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent sm:text-sm"
                  />
                </div>
              </div>
              <div>
