  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h1 className="text-3xl font-bold tracking-tight text-slate-900 dark:text-slate-100">{t('dashboard.companyTitle')}</h1>
                  ...
                  return (
                    <tr key={app.id} className="hover:bg-slate-100 dark:hover:bg-slate-800/30 transition-colors">
                      <td className="px-6 py-4">
                        ...
                        <p className="text-[10px] text-slate-500 dark:text-slate-400 uppercase font-bold">{app.product?.name}</p>
                      </td>
                  ...
                  return (
                    <tr key={claim.id} className="hover:bg-slate-100 dark:hover:bg-slate-800/30 transition-colors">
                      <td className="px-6 py-4">
                        ...
                        <p className="text-[10px] text-slate-500 dark:text-slate-400 mt-1 italic line-clamp-1">"{claim.description}"</p>
                      </td>
                      <td className="px-6 py-4 text-center">
                        <span className={`px-2 py-1 rounded-md text-[10px] font-bold uppercase border ${
