...
export default async function CompanyPoliciesPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold tracking-tight text-white">Company Policies</h1>
        <p className="text-zinc-400 mt-1 text-sm">Active policies issued by your company.</p>
      </div>
