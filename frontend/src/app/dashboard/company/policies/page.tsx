...
export default async function CompanyPoliciesPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold tracking-tight text-slate-900">Company Policies</h1>
        <p className="text-slate-600 mt-1 text-sm">Active policies issued by your company.</p>
      </div>
            ...
            <table className="w-full text-left text-sm min-w-[800px]">
              ...
              <tbody className="divide-y divide-zinc-800">
                {policies.map((policy: any) => (
                  <tr key={policy.id} className="hover:bg-slate-100/30 transition-colors">
