...
export default async function ClientClaimDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="space-y-8 max-w-4xl">
      <Link href="/dashboard/client" className="inline-flex items-center gap-2 text-zinc-400 hover:text-white transition-colors text-sm font-medium">
      ...
      <div>
        {policy ? (
          <Link href={`/dashboard/client/policies/${policy.id}`} className="block group">
            <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-5 flex items-center gap-4 group-hover:border-zinc-700 transition-colors">
