        ...
        <div className="flex-1">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div>
              ...
              <p className="text-slate-600 dark:text-slate-400 mt-1">Review your application details and status.</p>
            </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-6 shadow-md">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h2 className="text-lg font-bold text-slate-900 dark:text-slate-100">Product Overview</h2>
          </div>
          {product ? (
            <div className="space-y-4">
              <div>
                <p className="text-xs text-slate-500 dark:text-slate-400 uppercase tracking-wider font-semibold">Insurance Plan</p>
              ...
              {product.company && (
                <div className="pt-4 border-t border-slate-200 dark:border-slate-800/50">
                  <p className="text-xs text-slate-500 dark:text-slate-400 uppercase tracking-wider font-semibold">Underwriter</p>
          ...
          {risk ? (
            <div className="flex-1 flex flex-col">
              <div className="flex items-end gap-3 mb-4">
                ...
                <span className="text-sm text-slate-500 dark:text-slate-400 mb-1">/ 100 score</span>
              </div>
              <div className="mb-4">
        ...
        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-6 shadow-md md:col-span-2">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="p-4 bg-slate-50 dark:bg-[#060b1a]/50 rounded-lg border border-slate-200 dark:border-slate-800">
              <p className="text-xs text-slate-500 dark:text-slate-400 uppercase tracking-wider font-semibold">Submitted On</p>
              <p className="text-slate-700 dark:text-slate-300 mt-1 font-medium">{formatDate(app.createdAt)}</p>
            </div>
            <div className="p-4 bg-slate-50 dark:bg-[#060b1a]/50 rounded-lg border border-slate-200 dark:border-slate-800">
              <p className="text-xs text-slate-500 dark:text-slate-400 uppercase tracking-wider font-semibold">Last Updated</p>
