  ...
  return (
    <div className="max-w-6xl mx-auto space-y-8 animate-in fade-in duration-500">
      ...
      {policy.status === 'PENDING_PAYMENT' && (
        <div className="bg-blue-700/10 border border-blue-700/20 rounded-2xl p-6 flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex items-center gap-4 text-center md:text-left">
            <div className="h-12 w-12 rounded-full bg-blue-700/20 flex items-center justify-center shrink-0">
              <CreditCard className="h-6 w-6 text-blue-700" />
            </div>
            <div>
              <p className="text-blue-700 font-bold uppercase text-xs tracking-widest">Payment Required</p>
              <p className="text-slate-700 text-sm mt-1">Activate your policy today by completing the annual premium payment.</p>
            </div>
          </div>
          ...
          <div className="space-y-4">
            {policy.claims && policy.claims.length > 0 ? (
              policy.claims.map((claim: any) => (
                <div key={claim.id} className="bg-white border border-slate-200 rounded-2xl overflow-hidden hover:border-slate-300 transition-colors">
                        ...
                        <div className="flex flex-wrap gap-2">
                          {claim.documents.map((doc: any) => (
                            <a 
                              ...
                              className="inline-flex items-center gap-2 px-3 py-1.5 rounded bg-slate-100 border border-slate-300 text-xs text-slate-700 hover:text-slate-900 hover:border-zinc-600 transition-colors"
                            >
              ...
              <div className="bg-white/50 border border-slate-200 border-dashed rounded-2xl p-12 text-center">
                ...
                <p className="text-slate-500">No claims filed yet against this policy.</p>
