  ...
  if (data.status === 403) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] p-8 border-2 border-dashed border-rose-900/30 rounded-3xl bg-rose-950/10 text-center">
        ...
        <p className="text-slate-600 max-w-md">Platform administration is restricted to authorized personnel only.</p>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-8">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h1 className="text-3xl font-bold tracking-tight text-slate-900">{t('dashboard.adminTitle')}</h1>
          <p className="text-slate-600 mt-1">{t('dashboard.adminSubtitle')}</p>
        </div>
      </div>
        ...
        >
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-[10px] text-slate-500 font-medium uppercase tracking-tight">Create new staff accounts</p>
            </div>
          </div>
        </Link>
        ...
        >
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-[10px] text-slate-500 font-medium uppercase tracking-tight">Compliance event history</p>
            </div>
          </div>
        </Link>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 xl:grid-cols-7 gap-4">
        <div className="bg-white border border-slate-200 rounded-xl p-4">
          <div className="flex items-center justify-between mb-2">
            <span className="text-[10px] uppercase font-bold text-slate-500 tracking-wider">Tenants</span>
            <Database className="h-4 w-4 text-blue-500" />
          </div>
          <p className="text-xl font-bold text-slate-900"><CountUpNumber value={totalCompanies} /></p>
        </div>
        
        <div className="bg-white border border-slate-200 rounded-xl p-4">
          <div className="flex items-center justify-between mb-2">
            <span className="text-[10px] uppercase font-bold text-slate-500 tracking-wider">Users</span>
            <Users className="h-4 w-4 text-emerald-500" />
          </div>
          <p className="text-xl font-bold text-slate-900"><CountUpNumber value={totalApplicants} /></p>
        </div>

        <div className="bg-white border border-slate-200 rounded-xl p-4">
          <div className="flex items-center justify-between mb-2">
            <span className="text-[10px] uppercase font-bold text-slate-500 tracking-wider">Products</span>
            <Package className="h-4 w-4 text-blue-500" />
          </div>
          <p className="text-xl font-bold text-slate-900"><CountUpNumber value={totalProducts} /></p>
        </div>

        <div className="bg-white border border-slate-200 rounded-xl p-4">
          <div className="flex items-center justify-between mb-2">
            <span className="text-[10px] uppercase font-bold text-slate-500 tracking-wider">Apps</span>
            <ShieldCheck className="h-4 w-4 text-emerald-500" />
          </div>
          <p className="text-xl font-bold text-slate-900"><CountUpNumber value={totalApps} /></p>
        </div>

        <div className="bg-white border border-slate-200 rounded-xl p-4">
          <div className="flex items-center justify-between mb-2">
            <span className="text-[10px] uppercase font-bold text-slate-500 tracking-wider">Policies</span>
            <ShieldCheck className="h-4 w-4 text-blue-700" />
          </div>
          <p className="text-xl font-bold text-slate-900"><CountUpNumber value={totalPolicies} /></p>
        </div>

        <div className="bg-white border border-slate-200 rounded-xl p-4">
          <div className="flex items-center justify-between mb-2">
            <span className="text-[10px] uppercase font-bold text-slate-500 tracking-wider">Claims</span>
            <Activity className="h-4 w-4 text-rose-500" />
          </div>
          <p className="text-xl font-bold text-slate-900"><CountUpNumber value={totalClaims} /></p>
        </div>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-8">
        ...
        <section className="bg-white border border-slate-200 rounded-2xl overflow-hidden shadow-xl">
          <div className="px-6 py-4 border-b border-slate-200 bg-white/50 flex items-center gap-2">
            ...
            <h2 className="text-lg font-bold text-slate-900">Platform Tenants</h2>
          </div>
            ...
            <table className="w-full text-left text-sm">
              ...
              <tbody className="divide-y divide-zinc-800">
                {companies.map((company: any) => (
                  <tr key={company.id} className="hover:bg-slate-100/30 transition-colors">
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-3">
                        <div className="h-9 w-9 rounded-lg bg-slate-100 border border-slate-300 flex items-center justify-center text-xs font-bold text-blue-700">
                    ...
                    <td className="px-6 py-4">
                      <p className="text-xs text-slate-600 line-clamp-1">{company.description || "No description provided."}</p>
                    </td>
        ...
        <section className="bg-white border border-slate-200 rounded-2xl overflow-hidden shadow-xl">
          <div className="px-6 py-4 border-b border-slate-200 bg-white/50 flex items-center gap-2">
            ...
            <h2 className="text-lg font-bold text-slate-900">Global Application Pipeline</h2>
          </div>
          <div className="p-0 overflow-x-auto">
            <table className="w-full text-left text-sm">
              <thead className="bg-slate-50 text-slate-500 uppercase text-[10px] font-bold tracking-wider">
                  ...
                  return (
                    <tr key={app.id} className="hover:bg-slate-100/30 transition-colors">
                      <td className="px-6 py-4">
                        ...
                        <p className="text-[10px] text-slate-500 uppercase font-bold">{app.product?.name} <span className="text-slate-300 mx-1">/</span> {app.product?.company?.name}</p>
                      </td>
        ...
        <section className="bg-white border border-slate-200 rounded-2xl overflow-hidden shadow-xl xl:col-span-2">
          <div className="px-6 py-4 border-b border-slate-200 bg-white/50 flex items-center gap-2">
            <ShieldAlert className="h-5 w-5 text-rose-400" />
            <h2 className="text-lg font-bold text-slate-900">Global Claims Monitor</h2>
          </div>
          <div className="p-0 overflow-x-auto">
            <table className="w-full text-left text-sm">
              <thead className="bg-slate-50 text-slate-500 uppercase text-[10px] font-bold tracking-wider">
                  ...
                  return (
                    <tr key={claim.id} className="hover:bg-slate-100/30 transition-colors">
                      <td className="px-6 py-4 max-w-xs">
                        ...
                        <p className="text-xs text-slate-500 line-clamp-1 italic mt-1">"{claim.description}"</p>
                      </td>
