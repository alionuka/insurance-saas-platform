...
export default async function AuditLogPage() {
  ...
  const getActionColor = (action: string) => {
    ...
    if (a.includes('application') || a.includes('claim') || a.includes('policy')) return 'bg-indigo-500/10 text-indigo-400 border-indigo-500/20';
                ...
                <tr key={log.id} className="hover:bg-zinc-800/30 transition-colors">
                  ...
                  <td className="px-6 py-4">
                    <details className="group">
                      <summary className="list-none cursor-pointer flex items-center gap-1 text-[10px] font-bold uppercase text-indigo-400 hover:text-indigo-300 transition-colors">
