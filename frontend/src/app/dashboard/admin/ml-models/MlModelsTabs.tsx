  ...
  return (
    ...
    >
      ...
      <div className="p-3 bg-zinc-950 border-t border-zinc-800">
        <p className="text-xs font-semibold text-zinc-300 group-hover:text-blue-400 transition-colors">{caption}</p>
                ...
                {best_params && Object.entries(best_params).length > 0 ? (
                  Object.entries(best_params).map(([key, val]: any) => (
                    ...
                    >
                      ...
                      <span className="text-xs text-blue-400 font-mono font-bold mt-0.5">
          ...
          <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-6 shadow-md lg:col-span-3 flex flex-col justify-between">
                  ...
                  <tbody className="divide-y divide-zinc-800/60">
                    {cv_summary && Object.entries(cv_summary).map(([name, summary]: any) => {
                      ...
                      return (
                        <tr 
                          key={name} 
                          className={`hover:bg-zinc-800/20 transition-colors ${isBest ? 'bg-blue-500/5 font-semibold text-white' : 'text-zinc-300'}`}
                        >
            ...
            <div className="mt-4 pt-3 border-t border-zinc-800/60 flex items-center gap-4 text-[10px] text-zinc-500 font-mono">
              <div className="flex items-center gap-1.5">
                <div className="h-2.5 w-2.5 rounded bg-blue-500/10 border border-blue-500/30"></div>
            ...
            {permutation_importance && permutation_importance.length > 0 ? (
              ...
              <div className="flex-1 flex flex-col items-center justify-center p-6 border border-dashed border-zinc-800 rounded-xl">
                ...
                <p className="text-xs text-zinc-500 mt-2 text-center max-w-md leading-relaxed">
                  Fraud Detection використовує <span className="text-blue-400 font-mono">TF-IDF</span> на ~1000+ текстових ознаках з опису claim. Permutation importance для такого простору ознак нечитабельний.
                </p>
            ...
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-2">
                ...
                <div>
                  ...
                  <p className="text-zinc-300 text-sm mt-0.5 font-bold font-mono text-blue-400">
