                        ...
                        {policy ? (
                          <>
                            <div className="flex items-center gap-1.5">
                              <span className="text-sm font-mono text-amber-400 font-bold">{policy.policyNumber}</span>
                  ...
                  <tr key={`${claim.id}-docs`} className="bg-zinc-950/20">
                    <td colSpan={7} className="px-6 py-0 border-b border-zinc-800">
                      <details className="group">
                        <summary className="list-none cursor-pointer py-3 flex items-center gap-2 text-[10px] text-zinc-500 hover:text-amber-400 uppercase font-bold tracking-tight transition-colors">
