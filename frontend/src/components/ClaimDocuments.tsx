  ...
  return (
    <div className="p-4 bg-zinc-950/50 border border-zinc-800 rounded-lg mt-2 space-y-4">
      <div className="flex items-center justify-between">
        ...
        {canUpload && (
          <label className="cursor-pointer bg-indigo-600 hover:bg-indigo-500 text-white text-[10px] font-bold uppercase py-1.5 px-3 rounded flex items-center gap-2 transition-colors disabled:opacity-50">
              ...
              <div className="flex items-center gap-3 overflow-hidden">
                ...
                <div className="overflow-hidden">
                  <a 
                    ...
                    className="text-sm font-medium text-white hover:text-indigo-400 transition-colors truncate block max-w-xs flex items-center gap-2"
                  >
                    {doc.filename}
