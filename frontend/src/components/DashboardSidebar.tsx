      ...
      >
        ...
        <div className="h-16 flex items-center justify-between px-4 border-b border-zinc-800 shrink-0">
          <div className="flex items-center min-w-0">
            <ShieldCheck className="h-6 w-6 text-teal-500 mr-2 shrink-0" />
            ...
            {navItems.map((item) => {
              ...
              return (
                ...
                >
                  ...
                  <Icon className={`mr-3 h-5 w-5 shrink-0 ${isActive ? 'text-teal-400' : 'text-zinc-500'}`} />
        ...
        <div className="p-4 border-t border-zinc-800 shrink-0">
          <div className="flex items-center justify-between">
            <div className="flex items-center min-w-0 pr-3">
              <div className="h-9 w-9 rounded-full bg-zinc-800 border border-zinc-700 flex items-center justify-center overflow-hidden text-xs font-bold text-teal-400 shrink-0">
                {user?.avatarUrl ? (
                  <img
                    src={user.avatarUrl}
        ...
        {/* Drag-to-resize handle — invisible 4px strip on the right edge.
            Hover reveals a subtle teal line so the affordance is
        ...
        >
          ...
          <div className="absolute inset-y-0 right-0 w-px bg-zinc-800 group-hover:bg-teal-500 group-hover:w-0.5 transition-all" />
        </div>
      </aside>
