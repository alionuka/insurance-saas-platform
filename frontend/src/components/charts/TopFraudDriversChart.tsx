...
export default function TopFraudDriversChart({ drivers }: { drivers: FraudDriver[] }) {
    ...
    return (
      <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-6 h-full">
        <div className="flex items-center gap-2 mb-2">
          ...
          <h3 className="text-lg font-bold text-white">Top Fraud Drivers</h3>
        </div>
        <p className="text-xs text-zinc-500 mb-6">Aggregated fraud feature contributions across all claims</p>
        <div className="flex items-center justify-center h-[220px] border border-dashed border-zinc-800 rounded-xl">
          <p className="text-sm text-zinc-500">No fraud assessments yet.</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-6 h-full">
      ...
      <p className="text-xs text-zinc-500 mb-4">Cumulative fraud feature impact (SHAP) across all claim assessments</p>
